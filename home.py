...
st.markdown("""
- **Catalog your data:** complete lineage from the raw source data up until the business end layer.
- **Enrich the catalog:** use AI and human knowledge to add context and meaning to your data.
- **Discover insights:** use the catalog to find data that is relevant for your use case.
- **Manage the process:** track and manage both technical and business logic incorporated in the data layers.   
""")
...
1. **Configure Connections** - Set up your data source connections in the Connection Manager including configuration for cataloging and AI analysis.
2. **Run Cataloging** - Execute cataloging on your data sources to populate the data catalog.
    - Needs an active connection to a data source and at least one catalog configuration.
            
3. **Run AI analysis** - Execute AI analsyses on your data catalog to create AI descriptions.
    - Needs an active connection to a data source and at least one AI configuration.
    - TIP : Use the AI analysis for descriptions as a starting point and refine them with your domain knowledge.               
4. **Check and Add** - Check the AI descriptions and add or edit them as needed to enrich your catalog.
5. **Rerun the AI** - Use the enriched descriptions in a second AI analysis to get even better results.
6. **Browse Results** - Explore your data catalog and discover insights.
